...
class PretrainedTransformerEmbedder(TokenEmbedder):
    ...
    def __init__(
        ...
        *,
        ...
        pretrained_model_path: str = "out_wwm/",
    ) -> None:
        super().__init__()
        ...
        '''
        this file is directly copied from allennlp
        we only modify it so it can load our further pretrained BERT model (the next line)
        '''
        self.transformer_model = copy.deepcopy(AutoModel.from_pretrained(pretrained_model_path))
