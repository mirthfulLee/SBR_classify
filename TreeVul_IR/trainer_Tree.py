...
@Trainer.register("custom_gradient_descent", constructor="from_partial_objects")
class CustomGradientDescentTrainer(Trainer):
    ...
    def __init__(
        ...
        custom_callbacks: List[TrainerCallback] = None,
        ...
        self._custom_callbacks = custom_callbacks or []  # custom callbacks, which will be called before the evaluation
    ...
    def _try_train(self) -> Tuple[Dict[str, Any], int]:
        ...
        for epoch in range(epoch_counter, self._num_epochs):
            ...
            # custom_callbacks is called before evaluation
    ...
    def from_partial_objects(
        ...
        custom_callbacks: List[Lazy[TrainerCallback]] = None,
        enable_default_callbacks: bool = True,
        run_sanity_checks: bool = True,
    ) -> "Trainer":
        """
        ...
        custom_callbacks_: List[TrainerCallback] = []
        for callback_ in custom_callbacks or []:
            custom_callbacks_.append(callback_.construct(serialization_dir=serialization_dir))
        ...
        return cls(
            ...
            custom_callbacks=custom_callbacks_,
