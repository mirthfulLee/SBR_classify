...
allennlp evaluate TreeVul_IR/out_treevul/model.tar.gz data/test_samples_compressed.csv --output-file TreeVul_IR/out_treevul/test_metrics.json --predictions-output-file TreeVul_IR/out_treevul/test_results.json --batch-size 512 --cuda-device 2 --include-package TreeVul_IR
